                ...
                <>
                  ...
                  <div className="mt-4 relative">
                    ...
                    <input
                      ...
                      className="w-full border bg-[#FFFCF3] border-[#060608] rounded-full p-2 pr-10"
                    />
                    {/* Password Toggle Button */}
                    <button
                      type="button"
                      className="absolute inset-y-0 mt-4 right-0 pr-3 flex items-center text-sm leading-5"
                      onClick={() => setShowPassword(!showPassword)}
                    >
                      {showPassword ? "🙈" : "👁️"} {/* Emoji for visibility toggle */}
                    </button>
                  </div>
                  <div className="mt-4">
                    <label className="block text-sm font-semibold mb-2">
