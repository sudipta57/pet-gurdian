...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* About Us */}
      <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between bg-gray-50 py-12 px-6 sm:px-12 lg:px-24">
        {/* Left Text Section */}
        <div className="lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
          ...
          <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold font-montserrat text-[#060608] mb-4">
          ...
          <button className="flex items-center gap-2 px-6 py-3 bg-black text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition duration-300">
            READ MORE
      ...
      <div className="bg-gray-50 py-16 items-center px-8 lg:px-24">
        <div className="flex justify-center mb-4">
          <h2 className="text-4xl sm:text-[40px] md:text-[48px] lg:text-[56px] font-bold font-montserrat text-[#BF985F] mb-4 flex items-center">
            Our Services
            <span className="text-yellow-500 ml-2">
      ...
      <div className="bg-white py-10">
        ...
        <p className="text-center font-montserrat p-10">
          Pellentesque maximus augue orci, quis congue purus iaculison id.
          ...
          thisaton Vestibulum ut aliquet risus. In hac habitasse plateajoa
      ...
      >
        <div className="container mx-auto px-6 md:px-12 lg:flex lg:items-center lg:justify-between items-center">
          {/* Left Section */}
          ...
          <div className="lg:w-1/2 mt-8 lg:mt-0 flex justify-center lg:justify-end">
            <img
              ...
              alt="Why Choose Us"
              className="w-full h-auto max-w-md sm:max-w-lg lg:max-w-none lg:h-full object-cover rounded-lg "
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 flex flex-col items-center p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 max-w-[1000px] gap-6">
          {Array(3)
            .fill(0)
            .map((_, index) => (
              <div
              ...
              >
                ...
                <p className="text-gray-700 mb-6">
                  Pellentesque maximus augue orci, quis congue purus iaculis id.
                  Maecenas eu lorem quis massa molestie vulputate in sit amet
                  diam. Cras eu odio sit amet ipsum cursus.
                </p>
      ...
      <div
        className="flex flex-col md:flex-row items-stretch p-6 md:p-12 lg:p-20"
        style={{
      ...
      >
        {/* Left Section - Form */}
        <div className="bg-yellow-100 md:w-1/2 p-6 md:p-8 flex flex-col justify-center rounded-t-lg md:rounded-l-lg md:rounded-tr-none shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <div className="relative">
                <input
                  ...
                  className="peer bg-yellow-100 border-b-2 border-black w-full p-2 text-[#060608] placeholder:text-black focus:outline-none focus:border-black"
                />
              </div>
              <div className="relative">
                <input
