...
export default function Product() {
  ...
  return (
    <div>
      <div className="bg-[#FFFFFF] py-10 mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 md:grid-cols-4 gap-2 px-4 max-w-[1300px] mx-auto">
        ...
        <div className="text-center mt-8">
          <button className="bg-yellow-500 hover:bg-yellow-400 text-black px-6 py-2 rounded-full font-bold">
            VIEW MORE →
          </button>
        </div>
      </div>
